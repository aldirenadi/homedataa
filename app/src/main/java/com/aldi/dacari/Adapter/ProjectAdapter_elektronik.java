...
public class ProjectAdapter_elektronik extends RecyclerView.Adapter<ProjectAdapter_elektronik.ViewHolder> {

    private Context mContext;
    private List<Project> mProjects;

    public ProjectAdapter_elektronik(Context mContext, List<Project> mProjects, boolean b){
    ...
    @NonNull
    @Override
    public ProjectAdapter_elektronik.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.project_item, parent, false);
        return new ProjectAdapter_elektronik.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProjectAdapter_elektronik.ViewHolder holder, int position) {
        ...
        holder.type.setText("Servis Elektronik");
