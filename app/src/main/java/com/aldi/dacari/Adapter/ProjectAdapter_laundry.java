...
public class ProjectAdapter_laundry extends RecyclerView.Adapter<ProjectAdapter_laundry.ViewHolder> {

    private Context mContext;
    private List<Project> mProjects;

    public ProjectAdapter_laundry(Context mContext, List<Project> mProjects, boolean b){
    ...
    @NonNull
    @Override
    public ProjectAdapter_laundry.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.project_item, parent, false);
        return new ProjectAdapter_laundry.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProjectAdapter_laundry.ViewHolder holder, int position) {
        ...
        holder.type.setText("Jasa Laundry");
