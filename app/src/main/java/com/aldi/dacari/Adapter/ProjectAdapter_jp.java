...
public class ProjectAdapter_jp extends RecyclerView.Adapter<ProjectAdapter_jp.ViewHolder> {

    private Context mContext;
    private List<Project> mProjects;

    public ProjectAdapter_jp(Context mContext, List<Project> mProjects, boolean b){
    ...
    @NonNull
    @Override
    public ProjectAdapter_jp.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.project_item, parent, false);
        return new ProjectAdapter_jp.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProjectAdapter_jp.ViewHolder holder, int position) {
        ...
        holder.type.setText("Jasa Pembersihan");
