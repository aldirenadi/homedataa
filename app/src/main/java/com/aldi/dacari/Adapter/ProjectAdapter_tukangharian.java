...
public class ProjectAdapter_tukangharian extends RecyclerView.Adapter<ProjectAdapter_tukangharian.ViewHolder> {

    private Context mContext;
    private List<Project> mProjects;

    public ProjectAdapter_tukangharian(Context mContext, List<Project> mProjects, boolean b){
    ...
    @NonNull
    @Override
    public ProjectAdapter_tukangharian.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.project_item, parent, false);
        return new ProjectAdapter_tukangharian.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProjectAdapter_tukangharian.ViewHolder holder, int position) {
        ...
        holder.type.setText("Tukang Harian");
