...
public class ProjectAdapter_tukangledeng extends RecyclerView.Adapter<ProjectAdapter_tukangledeng.ViewHolder> {

    private Context mContext;
    private List<Project> mProjects;

    public ProjectAdapter_tukangledeng(Context mContext, List<Project> mProjects, boolean b){
    ...
    @NonNull
    @Override
    public ProjectAdapter_tukangledeng.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.project_item, parent, false);
        return new ProjectAdapter_tukangledeng.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProjectAdapter_tukangledeng.ViewHolder holder, int position) {
        ...
        holder.type.setText("Tukang Ledeng");
