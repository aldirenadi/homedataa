...
import com.aldi.dacari.Adapter.AldiAdapter_;
...
public class BookingFragment_penyedia extends Fragment {
...
//    FirebaseDatabase firebaseDatabase;
    ...
    private AldiAdapter_ aldiAdapter_;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_booking_penyedia, container, false);

        recyclerView = viewGroup.findViewById(R.id.recycle_view_booking_penyedia);
    ...
    private void bookingList() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                aldiAdapter_ = new AldiAdapter_(getContext(), mUsers, true);
                recyclerView.setAdapter(aldiAdapter_);
            }
